...
- (id)initWithTitle:(NSString *)title
        inputPlaceholder:(NSString *)content
    leftButtonTitle:(NSString *)leftTitle
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        CGFloat contentLabelWidth = kAlertWidth - 16;
        self.input = [[UITextField alloc] initWithFrame:CGRectMake((kAlertWidth - contentLabelWidth) * 0.5, CGRectGetMaxY(self.alertTitleLabel.frame), contentLabelWidth, 60)];
        self.input.borderStyle = UITextBorderStyleRoundedRect;
        self.input.placeholder = content;
        self.input.textAlignment = self.alertTitleLabel.textAlignment = NSTextAlignmentCenter;
        self.input.textColor = [UIColor colorWithRed:127.0/255.0 green:127.0/255.0 blue:127.0/255.0 alpha:1];
        self.input.font = [UIFont systemFontOfSize:15.0f];
