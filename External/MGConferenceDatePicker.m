...
- (void)buildControl {
    ...
    //Create save button
    _saveButton = [[MGPickerButton alloc] initWithFrame:CGRectMake(10.0, 10.0, (self.frame.size.width-20.0)/2, SAVE_AREA_HEIGHT-20.0)];
    ...
    _cancelButton = [[MGPickerButton alloc]initWithFrame:CGRectMake(10+(self.frame.size.width-20.0)/2+5, 10, (self.frame.size.width-20.0)/2, SAVE_AREA_HEIGHT-20.0)];
